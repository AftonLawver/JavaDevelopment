...
public class DisplayQueryResults2 extends JFrame 
{
   ...
   static final String PASSWORD= "102992";
   ...
   {   
	 ...
	 JLabel filterLabel = new JLabel("Filter");
         ...
         boxSouth.add( clearFilterButton );
       ...
       // create event listener for exitButton
